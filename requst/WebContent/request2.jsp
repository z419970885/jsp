...
<input type="radio" name="2" value="A">setMaxInactiveInteval(int interval)<br>
<input type="radio" name="2" value="B">getAttributeName()<br>
<input type="radio" name="2" value="C">set Attribute(String name,Java.lang.Object value)<br>
...
<input type="radio" name="4" value="B">用来删除默认页面的范围或指定范围之中的已命名对象<br>
<input type="radio" name="4" value="C">按照页面请求、会话以及应用程序范围的顺序实现对某个已命名属性的搜索<br>
<input type="radio" name="4" value="D">以字符串的形式返回一个对异常的描述<br>
